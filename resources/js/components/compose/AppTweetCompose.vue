<template>
	<form class="flex" @submit.prevent="submit">
		...
		<div class="flex-grow">
			<app-tweet-compose-textarea v-model="form.body" placeholder="Whats happening?"/>

			<app-tweet-media-progress v-if="media.progress"class="mb-4" :progress="media.progress"/>
